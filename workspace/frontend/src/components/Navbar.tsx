            ...
            <div className="ml-4 flex items-center md:ml-6">
              <div className="ml-3 relative">
                <div className="flex items-center">
                  <Link
                    to="/profile"
                    className="flex items-center mr-4 bg-gray-100 py-2 px-3 rounded-full hover:bg-gray-200 transition-colors cursor-pointer"
                    title="View profile"
                  >
          ...
          <div className="sm:hidden">
            <div className="pt-2 pb-3 space-y-1 border-t border-gray-200">
              <div className="flex flex-col px-4 py-2">
                <Link
                  to="/profile"
                  className="flex items-center py-2 bg-gray-100 mb-2 px-3 rounded-full hover:bg-gray-200 transition-colors"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                  </svg>
